...
Firstmate is its own repo, so new tracked material (`AGENTS.md`, `bin/`, `.agents/skills/`, and public `skills/`) reaches `main` through the normal PR path and then sits there until each running firstmate pulls it.
